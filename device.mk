...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/android.hardware.camera.manual_postprocessing.xml:system/vendor/etc/permissions/android.hardware.camera.manual_postprocessing.xml \
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/wifi/hostapd_hisi.conf:system/vendor/etc/wifi/hostapd_hisi.conf \
    $(LOCAL_PATH)/wifi/p2p_supplicant_hisi.conf:system/vendor/etc/wifi/p2p_supplicant_hisi.conf \
    $(LOCAL_PATH)/wifi/p2p_supplicant_overlay.conf:system/vendor/etc/wifi/p2p_supplicant_overlay.conf \
    $(LOCAL_PATH)/wifi/wpa_supplicant_hisi.conf:system/vendor/etc/wifi/wpa_supplicant_hisi.conf \
    $(LOCAL_PATH)/wifi/p2p_supplicant_overlay.conf:system/vendor/etc/wifi/p2p_supplicant_overlay.conf
